...
summary(datos_simce)`,
  },
  {
    ...
    contexto:
      "CASEN es una de las principales encuestas sociales de Chile. Permite estudiar condiciones socioeconómicas de personas y hogares, incluyendo ingreso, educación, pobreza y asistencia escolar. Para fines estadísticos, es una base muy útil porque conecta variables sociales con posibles resultados educativos, laborales o económicos.",
    usos:
      "Puede utilizarse para análisis exploratorio, comparación de grupos, regresión lineal, regresión logística, estudio de pobreza, relación entre escolaridad e ingreso y análisis por región.",
    tecnicas: [
      "Histogramas",
...
const areas = [
  ...
  { nombre: "Datos sociales", icono: "📊", descripcion: "Bases para ingreso, pobreza, escolaridad y desigualdad.", color: "#047857" },
  { nombre: "Medio ambiente", icono: "🌱", descripcion: "Bases para calidad del aire y análisis ambiental.", color: "#b45309" },
];
